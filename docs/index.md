...
- Root API entrypoint: `api/src/main/java/fr/dreamin/dreamapi/api/DreamAPI.java`
- Service loader/runtime: `core/src/main/java/fr/dreamin/dreamapi/core/service/ServiceAnnotationProcessor.java`
- Plugin bootstrap base: `plugin-base/src/main/java/fr/dreamin/dreamapi/plugin/DreamPlugin.java`
