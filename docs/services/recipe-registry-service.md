...
Navigation: `docs/services/recipe-category-registry-service.md` | `docs/services/index.md` | `docs/services/recipe-viewer-service.md`
...
- API: `api/src/main/java/fr/dreamin/dreamapi/api/recipe/service/RecipeRegistryService.java`
- Core: `core/src/main/java/fr/dreamin/dreamapi/core/recipe/service/RecipeRegistryServiceImpl.java`
