...
Navigation: `docs/services/animation-service.md` | `docs/services/index.md` | `docs/services/debug-service.md`
...
- API: `api/src/main/java/fr/dreamin/dreamapi/api/cuboid/service/CuboidService.java`
- Core: `core/src/main/java/fr/dreamin/dreamapi/core/cuboid/service/CuboidServiceImpl.java`
