...
Navigation: `docs/services/persistent-worldborder-service.md` | `docs/services/index.md` | `docs/services/team-service.md`
...
- Interface: `core/src/main/java/fr/dreamin/dreamapi/core/logger/PlayerDebugService.java`
- Implementation: `core/src/main/java/fr/dreamin/dreamapi/core/logger/PlayerDebugServiceImpl.java`
