...
Navigation: `docs/services/team-service.md` | `docs/services/index.md` | `docs/services/service-runtime.md`
...
- Interface: `core/src/main/java/fr/dreamin/dreamapi/core/time/day/impl/DayCycleService.java`
- Implementation: `core/src/main/java/fr/dreamin/dreamapi/core/time/day/impl/DayCycleServiceImpl.java`
