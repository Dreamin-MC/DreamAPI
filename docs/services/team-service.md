...
Navigation: `docs/services/player-debug-service.md` | `docs/services/index.md` | `docs/services/day-cycle-service.md`
...
- Interface: `core/src/main/java/fr/dreamin/dreamapi/core/team/TeamService.java`
- Implementation: `core/src/main/java/fr/dreamin/dreamapi/core/team/TeamServiceImpl.java`
