...
Navigation: `docs/services/cuboid-service.md` | `docs/services/index.md` | `docs/services/dialog-service.md`
...
- API: `api/src/main/java/fr/dreamin/dreamapi/api/logger/DebugService.java`
- Core: `core/src/main/java/fr/dreamin/dreamapi/core/logger/DebugServiceImpl.java`
- Dependency service: `core/src/main/java/fr/dreamin/dreamapi/core/logger/PlayerDebugServiceImpl.java`
