...
Navigation: `docs/services/recipe-registry-service.md` | `docs/services/index.md` | `docs/services/skin-service.md`
...
- API: `api/src/main/java/fr/dreamin/dreamapi/api/recipe/service/RecipeViewerService.java`
