...
Navigation: `docs/services/lang-service.md` | `docs/services/index.md` | `docs/services/recipe-category-registry-service.md`
...
- API: `api/src/main/java/fr/dreamin/dreamapi/api/luckperms/LuckPermsService.java`
- Core: `core/src/main/java/fr/dreamin/dreamapi/core/luckperms/LuckPermsServiceImpl.java`
- Dependency: `core/src/main/java/fr/dreamin/dreamapi/core/team/TeamServiceImpl.java`
