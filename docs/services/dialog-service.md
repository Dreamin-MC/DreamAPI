...
Navigation: `docs/services/debug-service.md` | `docs/services/index.md` | `docs/services/game-service.md`
...
- API: `api/src/main/java/fr/dreamin/dreamapi/api/dialog/DialogService.java`
- Core: `core/src/main/java/fr/dreamin/dreamapi/core/dialog/DialogServiceImpl.java`
