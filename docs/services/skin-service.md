...
Navigation: `docs/services/recipe-viewer-service.md` | `docs/services/index.md` | `docs/services/tablist-service.md`
...
- API: `api/src/main/java/fr/dreamin/dreamapi/api/skin/service/SkinService.java`
- Core: `core/src/main/java/fr/dreamin/dreamapi/core/skin/service/SkinServiceImpl.java`
