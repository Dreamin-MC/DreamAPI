...
[![Version](https://img.shields.io/badge/version-0.1.4-blue.svg)](https://github.com/Dreamin-MC/DreamAPI)
...
dependencies {
    compileOnly("com.github.Dreamin-MC:DreamAPI:0.1.4:all")
}
```
...
|--------|----------|---------------|
| 🧪 In active development | `v0.1.4` | Paper 26.2.1 |
