...
[![Version](https://img.shields.io/badge/version-0.5.0-blue.svg)](https://github.com/Dreamin-MC/DreamAPI)
...
dependencies {
  compileOnly("com.github.Dreamin-MC:DreamAPI:0.5.0")
}
```
...
|--------|-----------------|----------------|
| Active development | `v0.5.0` | Java 25 + Paper `26.1.2.build.+` |
