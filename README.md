...
[![Version](https://img.shields.io/badge/version-0.4.7-blue.svg)](https://github.com/Dreamin-MC/DreamAPI)
...
dependencies {
  compileOnly("com.github.Dreamin-MC:DreamAPI:0.4.7")
}
```
...
|--------|-----------------|----------------|
| Active development | `v0.4.7` | Java 25 + Paper `26.1.2.build.+` |
