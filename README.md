...
[![Version](https://img.shields.io/badge/version-0.2.1-blue.svg)](https://github.com/Dreamin-MC/DreamAPI)
...
dependencies {
    compileOnly("com.github.Dreamin-MC:DreamAPI:0.2.1:all")
}
```
...
|--------|----------|---------------|
| 🧪 In active development | `v0.2.1` | Paper 26.2.1 |
