...
[![Version](https://img.shields.io/badge/version-0.3.1-blue.svg)](https://github.com/Dreamin-MC/DreamAPI)
...
dependencies {
  compileOnly("com.github.Dreamin-MC:DreamAPI:0.3.1")
}
```
...
|--------|-----------------|----------------|
| Active development | `v0.3.1` | Java 25 + Paper `26.1.2.build.+` |
