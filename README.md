...
[![Version](https://img.shields.io/badge/version-0.2.9-blue.svg)](https://github.com/Dreamin-MC/DreamAPI)
...
dependencies {
  compileOnly("com.github.Dreamin-MC:DreamAPI:0.2.9")
}
```
...
|--------|-----------------|----------------|
| Active development | `v0.2.9` | Java 25 + Paper `26.1.2.build.+` |
